...
function Marq2() {
	...
	return (
		<section className="call-marq section-padding o-hidden">
			<div className="main-marq lrg sub-bg pt-20 pb-20">
				<div className="slide-har st1">
					<div className="box">
						...
						{AllMarquess.map((item, i) => (
							<div key={i} className="item secondary-colors">
								<h4 className="d-flex align-items-center secondary-colors">
									<span>{item}</span>
									<span className="icon-img-50 ml-40">
										<img src="/assets/imgs/star.png" alt="" />
									</span>
			...
			<div className="main-marq bord-item secondary-colors">
				<div className="slide-har st2">
					<div className="box">
						{AllContact.map((item, i) => (
							<div key={i} className="item">
								<h4 className="d-flex align-items-center secondary-colors">
									<span className="secondary-colors">{item}</span>
								</h4>
							</div>
						))}
					</div>
