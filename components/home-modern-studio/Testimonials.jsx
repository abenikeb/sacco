				...
				<div
					...
					<Swiper
						...
						<SwiperSlide>
							<div className="item">
								<div className="cont">
									<h6 className="sub-title mb-15">Project Managment Quality</h6>
									<div className="text">
										<p>
								...
								<div className="info">
									<div className="d-flex align-items-center">
										...
										<div className="ml-20">
											<h6 className="fz-18">Abrham Teklematiam</h6>
						...
						<SwiperSlide>
							<div className="item">
								<div className="cont">
									<h6 className="sub-title mb-15">Delivery Quality</h6>
									<div className="text">
										<p>
											“ I have been hiring people in this space for a number of
								...
								<div className="info">
									<div className="d-flex align-items-center">
										...
										<div className="ml-20">
											<h6 className="fz-18">Haile Tekle</h6>
											<span className="p-color opacity-8 fz-15 mt-5">
												Bright Customer
											</span>
										</div>
						...
						<SwiperSlide>
							<div className="item">
								<div className="cont">
									<h6 className="sub-title mb-15">Program Quality</h6>
									<div className="text">
										<p>
											“ I have been hiring people in this space for a number of
											years and I have never seen this level of professionalism.
								...
								<div className="info">
									<div className="d-flex align-items-center">
										...
										<div className="ml-20">
											<h6 className="fz-18">Habtom Megngstu</h6>
											<span className="p-color opacity-8 fz-15 mt-5">
												Bright Customer
											</span>
										</div>
