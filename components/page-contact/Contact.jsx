		...
		<section className="contact section-padding">
			<div className="container">
				<div className="row">
					...
					<div className="col-lg-7 offset-lg-1 valign secondary-color">
